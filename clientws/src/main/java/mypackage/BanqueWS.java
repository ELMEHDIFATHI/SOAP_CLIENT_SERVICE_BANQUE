 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8084/BanqueWS?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8084/BanqueWS?WSDL");
     ...
     * 
     * @return
     *     returns ServiceBanque
     */
    @WebEndpoint(name = "serviceBanquePort")
    public ServiceBanque getServiceBanquePort() {
        return super.getPort(new QName("http://ws/", "serviceBanquePort"), ServiceBanque.class);
    }
     ...
     */
    @WebEndpoint(name = "serviceBanquePort")
    public ServiceBanque getServiceBanquePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "serviceBanquePort"), ServiceBanque.class, features);
    }
